...
function fillSettingsForm(){
  ...
  $('#countryVisibleEgypt').checked=settings.country_visible_egypt!==false;
  $('#countryVisibleUae').checked=settings.country_visible_uae!==false;
  $('#countryVisibleSaudi').checked=settings.country_visible_saudi!==false;
